...
public class PaymentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = paymentObj.insertPayment(request.getParameter("cardHolderName"),
				request.getParameter("cardNumber"), request.getParameter("charge"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = paymentObj.updatePayment(paras.get("hidPayIDSave").toString(),
				paras.get("cardHolderName").toString(), paras.get("cardNumber").toString(),
